...
description: 유튜브, 웹페이지, PDF 등 다양한 소스에서 콘텐츠를 추출하여 인스타그램 스타일 카드뉴스로 변환. 나노바나 API로 배경 이미지를 자동 생성하고, Sunday Hug 스타일의 세련된 카드뉴스 제작. 사용자가 (1) 유튜브 URL을 주고 카드뉴스 제작을 요청하거나, (2) 웹페이지/블로그 URL로 카드뉴스를 요청하거나, (3) 특정 주제로 카드뉴스 제작을 요청할 때 사용.
---
